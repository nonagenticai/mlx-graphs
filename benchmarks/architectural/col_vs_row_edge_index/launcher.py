...
import scipy as sp
from col_index_functions import (get_src_dst_features_COL, is_undirected_COL,
                                 sort_edge_index_and_features_COL,
                                 sort_edge_index_COL, to_adjacency_matrix_COL,
                                 to_edge_index_COL,
                                 to_sparse_adjacency_matrix_COL)
from row_index_functions import (get_src_dst_features_ROW, is_undirected_ROW,
                                 sort_edge_index_and_features_ROW,
                                 sort_edge_index_ROW, to_adjacency_matrix_ROW,
                                 to_edge_index_ROW,
